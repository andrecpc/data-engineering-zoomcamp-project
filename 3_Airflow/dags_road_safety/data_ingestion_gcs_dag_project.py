...
dataset_file = "dft-road-casualty-statistics-accident-{{ execution_date.strftime(\'%Y\') }}.csv"
dataset_url = f"https://data.dft.gov.uk/road-accidents-safety-data/{dataset_file}"
path_to_local_home = os.environ.get("AIRFLOW_HOME", "/opt/airflow/")
# parquet_file = dataset_file.replace('.csv', '.parquet')
BIGQUERY_DATASET = os.environ.get("BIGQUERY_DATASET", 'project_data_all')
...
with DAG(
    dag_id="data_ingestion_gcs_dag_project",
    ...
    #             "tableId": "external_table_project",
    #         },
